...
//   // New function to send the invoice notification to the user
//  // Update the sendInvoiceNotification function in GenerateInvoice.jsx
...
const GenerateInvoice = () => {
  ...
  // Function to save invoice to the database
 // Update the saveInvoiceToDatabase function
